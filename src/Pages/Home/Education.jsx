        ...
        <div className="max-w-md p-8 sm:flex sm:space-x-6 ">
          <div className="flex-shrink-0 w-full mb-6 h-44 sm:h-32 sm:w-32 sm:mb-0">
            <img
              src={HeroImage}
              alt=""
              className="rounded ring-2 ring-offset-4 dark:bg-gray-500 ring-gray-700 ring-offset-gray-800"
            />
          </div>
          <div className="flex flex-col space-y-4">
            <div>
              <h2 className="text-2xl font-semibold">MD SHAMSUL ARIFIN</h2>
            ...
            <div className="space-y-1">
              <span className="flex items-center space-x-2">
                ...
                <span className="">arifin.shamsul.99@gmail.com</span>
              </span>
              <span className="flex items-center space-x-2">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <span className="">+8801825333535</span>
              </span>
            </div>
          </div>
        </div>
